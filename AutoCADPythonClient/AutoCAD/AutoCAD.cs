...
namespace Draftsocket.AutoCAD
{
    public partial class Session : ISession
    {
        ...
        private ClientMessage ExecuteServerMessage(ServerMessage Reply)
        {
            ...
            //var commandstring = Reply.Action;
            string commandstring = "MdiActiveDocument.Database";
            var aas = Application.DocumentManager.MdiActiveDocument;
            var obj = FollowPropertyPath(Application.DocumentManager, commandstring);
